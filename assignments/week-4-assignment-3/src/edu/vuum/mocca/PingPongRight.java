 ...
 * PlayPingPongThread and start these thread instances to correctly alternate
 * printing "Ping" and "Pong", respectively, on the console display.
 */
public class PingPongRight {
     ...
     * SimpleSemaphore to alternate printing "ping" and "pong" to the console
     * display.
     */
...
//        private final static int SECOND_SEMA = 1;
        ...
        public PlayPingPongThread(String stringToPrint,
                ...
                int maxIterations) {
            // TODO - You fill in here.
            this.action = stringToPrint;
            this.acquireTurn = semaphoreOne;
            this.releaseTurn = semaphoreTwo;
        ...
        public void run() {
            ...
            // TODO - You fill in here.
            for (int iterIdx = 0; iterIdx < mMaxLoopIterations; iterIdx++)
            {
                acquire();
